  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (profileError) console.error("Error creating base profile:", profileError);
        ...
        if (role === 'seeker') {
          const { error: seekerErr } = await supabase.from('seeker_profiles').insert([{ 
            ...
            title: targetJob,
            // 🛠️ THE FIX: Send empty defaults to satisfy database constraints
            skills: [], 
            experience: "0 years" 
          }]);
          ...
          const { error: providerErr } = await supabase.from('provider_profiles').insert([{ 
            id: data.user.id,
            full_name: fullName,
            contact_phone: phone, 
            location: location,
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="flex-1 space-y-5">
              ...
              <div className="bg-blue-50 p-5 rounded-xl border border-blue-100">
                <label className="block text-sm font-bold text-blue-800 mb-3">I am a:</label>
                <div className="flex gap-6">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input 
                      ...
                      className="text-blue-600 focus:ring-blue-500 w-5 h-5"
                    />
                    <span className="text-gray-800 font-medium">Job Provider</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-inner">
              <p className="text-lg font-bold text-gray-800 border-b border-gray-200 pb-3 mb-5 flex items-center gap-2">
                ...
                {role === "seeker" ? "Job Seeker Details" : "Job Provider Details"}
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  <input
                    type="text"
                    placeholder={role === "seeker" ? "Your Full Name" : "Contact Person's Full Name"}
                    required
                    value={fullName}
